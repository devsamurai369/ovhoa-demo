  ...
  <div class="container">
    <div class="board-grid">
      ...
      <div class="card rink-card">
        ...
        <p class="rink-notes">Private seasonal club &mdash; check in at the front desk. Hockey, figure skating and curling.</p>
      ...
      <div class="card rink-card">
        ...
        <p class="rink-notes">Miami University. Two NHL-size sheets &mdash; the &ldquo;A Pad&rdquo; is Steve Cady Arena, the &ldquo;B Pad&rdquo; is the recreation sheet. Allow extra travel time from Cincinnati.</p>
